...
// import { LoaderCircle, Youtube, Search, MessageSquare, FileText, Clock, ExternalLink } from "lucide-react"
...
//   return (
//     <div className="w-full max-w-6xl mx-auto p-8 bg-gradient-to-br from-gray-900 to-black text-red-50">
...
//           <div className="bg-gray-800 p-6 rounded-lg shadow-lg border border-red-800">
//             <h2 className="text-2xl font-semibold mb-6 text-red-400">Transcript Search Results</h2>
//             <div className="space-y-6">
//               {searchResults.map((result, index) => (
//                 <div key={index} className="bg-gray-900 rounded-lg p-4 shadow-md hover:shadow-lg transition-shadow duration-300">
//                   <div className="flex items-center justify-between mb-2">
//                     <div className="flex items-center space-x-2">
//                       <Clock className="text-red-400 w-4 h-4" />
//                       <span className="text-red-400 font-semibold">{formatTimestamp(result.timestamp)}</span>
//                     </div>
//                     <a
//                       href={generateYouTubeLink(videoId, result.timestamp)}
//                       target="_blank"
//                       rel="noopener noreferrer"
//                       className="text-red-400 hover:text-red-300 transition-colors duration-300 flex items-center space-x-1"
//                     >
//                       <span>Watch</span>
...
//   )
// }
import TalktoWebsite from '@/components/TalkTW'
import React from 'react'

const page = () => {
  return (
    <div><TalktoWebsite/></div>
  )
}
